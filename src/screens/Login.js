...
const Login = () => {
    ...
    const login = () => {
        ...
        if (!!email && !!password) {
            axios.post(`https://venda-pues-users-api.herokuapp.com/v1/auth`, formItem)
            .then(res => {
                if (res.status === 200) {
    ...
    return (
        <div>
            ...
            <img className="loginProducts" src={prods} />
            <div className="registerForm loginForm container col-3">
                ...
                <div className="input-group flex-nowrap mb-4">
                    ...
                    <input type="text" className="form-control" onChange={(value) => setEmail(value.target.value)} placeholder="Email" aria-label="Email" aria-describedby="addon-wrapping" />
                </div>
                <div className="input-group flex-nowrap mb-4">
                    <span className="input-group-text" id="addon-wrapping">
                ...
                <button onClick={login} type="button" className="btn btn-primary registerButton mb-4">Login</button>
            </div>
        </div>
    );
};
