...
const Register = () => {
  ...
  const login = () => {
    ...
    if (
      ...
      axios
        .post(`https://venda-pues-users-api.herokuapp.com/v1/user`, formItem)
        .then((res) => {
          if (res.status === 200) {
            axios
              .post(`https://venda-pues-users-api.herokuapp.com/v1/auth`, {
                email: email,
                password: password,
              })
              .then((res) => {
      ...
      <div className="registerForm container col-3">
          ...
          <div className="col-6">
            <div className="form-check">
              <input
                ...
                onChange={(value) => selectStoreRegister(value.target.checked)}
                type="radio"
                name="registerRadio"
                id="storeRadio"
              />
              <label
                className="form-check-label registerRadioLabels"
                htmlFor="storeRadio"
              >
                Registra tu tienda
              </label>
          ...
          <div className="col-6">
            <div className="form-check">
              <input
                className="form-check-input"
                onChange={(value) =>
                  selectProviderRegister(value.target.checked)
                }
                type="radio"
                name="registerRadio"
                id="provRadio"
        ...
        <div className="input-group flex-nowrap mb-1">
          <input
            type="text"
            className="form-control"
            onChange={(value) => setLastOwner(value.target.value)}
